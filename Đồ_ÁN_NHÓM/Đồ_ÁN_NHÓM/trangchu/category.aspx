<%@ Page Title="" Language="C#" MasterPageFile="~/layout/trangchu.Master" AutoEventWireup="true" CodeBehind="category.aspx.cs" Inherits="Đồ_ÁN_NHÓM.trangchu.category" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
      <style>

           #ContentPlaceHolder1_ds_category tr {
           float:left;
           margin:0px;
       }
                     ...
                     <div class="view overlay">
                      ...
                      <div class="card-body">
                        ...
                        <p class="card-text"><%# Eval("mota") %></p>
                          <div>
                              <asp:LinkButton class="link_home" ID="LinkButton1" PostBackUrl="home.aspx" runat="server">XEM</asp:LinkButton>
                          </div>
                      </div>
                    </div>
              </ItemTemplate>
